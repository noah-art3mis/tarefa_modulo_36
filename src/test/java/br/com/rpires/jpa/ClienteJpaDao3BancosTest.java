...
import br.com.rpires.dao.generic.jpa.Databases;
import br.com.rpires.dao.jpa.ClienteJpa2DAO;
...
public class ClienteJpaDao3BancosTest {
  ...
  public ClienteJpaDao3BancosTest() {
    ...
    this.clienteDB2Dao = new ClienteJpaDAO(Databases.PSQL_STAGING.getValue());
    this.clienteDB3Dao = new ClienteJpa2DAO(Databases.MYSQL_STAGING.getValue());
    rd = new Random();
  }
  ...
  private void excluir(
    ...
    IClienteJpaDAO<ClienteJpa> clienteDao
  ) {
    list.forEach(cli -> {
      try {
